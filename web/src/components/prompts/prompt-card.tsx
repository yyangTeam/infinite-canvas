        ...
        <Card
            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    {item.coverUrl ? <img src={item.coverUrl} alt={item.title} className="aspect-[4/3] w-full object-cover" /> : <div className="aspect-[4/3] w-full bg-stone-100 dark:bg-stone-800" />}
                </button>
            }
        >
            <button type="button" className="block w-full text-left" onClick={onOpen}>
